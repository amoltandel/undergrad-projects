...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("Error:  did not get any row values", cursor.moveToNext());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error in data validation (Location)", cursor, contentValues);
    ...
    public void testWeatherTable() {
        ...
        // Insert ContentValues into database and get a row ID back
        long weather_id = sqLiteDatabase.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, contentValues);
        // Query the database and receive a Cursor back
        Cursor cursor = sqLiteDatabase.query(WeatherContract.WeatherEntry.TABLE_NAME, null, null, null, null, null, null);
        // Move the cursor to a valid database row
        assertTrue("Data not received", cursor.moveToNext());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Couldnt validate weather data", cursor, contentValues);
        // Finally, close the cursor and database
        cursor.close();
        sqLiteDatabase.close();
    }
